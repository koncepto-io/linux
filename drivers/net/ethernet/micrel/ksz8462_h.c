...
static const struct of_device_id ks846x_ids[] = {
    { .compatible = "microchip,ksz8462", },
    { /* sentinel */ }
};

MODULE_DEVICE_TABLE(of, ks846x_ids);

static struct platform_driver ks846x_platform_driver = {
	.driver = {
		.name = KBUILD_MODNAME,
		.of_match_table = of_match_ptr(ks846x_ids),  
	},
	.probe = ks846x_probe,
...
module_platform_driver(ks846x_platform_driver);
